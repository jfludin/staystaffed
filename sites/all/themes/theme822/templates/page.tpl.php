...
<div id="page-wrapper">
    ...
    <div id="page">
        ...
        <header id="header" role="banner" class="clearfix">
            ...
            <div class="section-1 header-inner">
            ...
            <?php if ($page['header']): ?>
                ...
                <div class="section-2 clearfix banner-wr">
        ...
        <div id="main-wrapper" class="main-wr">
            ...
            <div class="glow">
                ...
                <div class="container-12">   
                    ...
                    <div class="grid-12">
                        <?php print render($page['our_expertise']); ?>
                    </div>
                ...
                <div class="container-12">   
                    ...
                    <div class="grid-12">
                        <?php print render($page['how_we_are']); ?>
                    </div>
